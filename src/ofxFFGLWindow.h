...
#ifdef TARGET_OPENGLES
class ofxFFGLWindow : public ofAppBaseGLESWindow{
#else
class ofxFFGLWindow : public ofAppBaseGLWindow {
#endif
...
public:
	...
	ofxFFGLWindow(ofxFFGLWindow & w) = delete;
	ofxFFGLWindow & operator=(ofxFFGLWindow & w) = delete;
...
private:
	static ofxFFGLWindow * setCurrent(GLFWwindow* windowP);
